...
func _check_size(viewport_size: Vector2i) -> void:
	...
	for route in [MenuRoute.Id.PLAY_MODE, MenuRoute.Id.PLAY_CUP, MenuRoute.Id.PLAY_READY, MenuRoute.Id.GARAGE, MenuRoute.Id.PROFILE, MenuRoute.Id.SETTINGS, MenuRoute.Id.CONTROLS]:
